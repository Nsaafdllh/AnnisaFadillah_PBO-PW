...
// Subclass 1: PembelianVIP
class PembelianVIP extends PembelianTiket {
  ...
  beliTiket(jumlahTiket) {
    const totalHarga = this.hargaTiket * jumlahTiket;
    return `Pembelian ${jumlahTiket} tiket VIP berhasil. Total harga: Rp${totalHarga}. Kapal: ${this.nama}, Kapasitas: ${this.kapasitasPenumpang}, Harga per tiket VIP: Rp${this.hargaTiket}`;
  }
}
...
// Testing
const pembelianVIP = new PembelianVIP("Kapal Laut Budiono Siregar", 2010, 500, 500000);
console.log(pembelianVIP.beliTiket(2));  // Membeli 2 tiket VIP
